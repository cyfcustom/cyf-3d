...
export function ConverterModule() {
  ...
  return (
    <div className="space-y-6" id="converter">
      <div className="space-y-2">
        <p className="text-xs uppercase tracking-wide text-primary font-semibold">{t('converter.moduleLabel')}</p>
        <h2 className="text-2xl font-bold">{t('converter.title')}</h2>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
          <h3 className="text-lg font-semibold">{t('converter.length')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
            <div className="space-y-1">
              <span className="text-xs text-muted-foreground">{t('converter.value')}</span>
              <Input
                type="number"
                inputMode="decimal"
                min="0"
            ...
            <div className="space-y-1">
              <span className="text-xs text-muted-foreground">{t('converter.result')}</span>
        ...
        <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
          <h3 className="text-lg font-semibold">{t('converter.area')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
            <div className="space-y-1">
              <span className="text-xs text-muted-foreground">{t('converter.value')}</span>
              <Input
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
          <h3 className="text-lg font-semibold">{t('converter.weight')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
            <div className="space-y-1">
              <span className="text-xs text-muted-foreground">{t('converter.value')}</span>
              <Input
        ...
        <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
          <h3 className="text-lg font-semibold">{t('converter.temperature')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
            <div className="space-y-1">
              <span className="text-xs text-muted-foreground">{t('converter.value')}</span>
              <Input
      ...
      <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
        <h3 className="text-lg font-semibold">{t('converter.pixelsDpi')}</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.widthCm')}</span>
            <Input
              type="number"
              inputMode="decimal"
              step="0.01"
          ...
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.heightCm')}</span>
            <Input
              type="number"
              inputMode="decimal"
              step="0.01"
          ...
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.outputPx')}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 pt-2">
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.widthPx')}</span>
            <Input
              type="number"
              inputMode="decimal"
              step="1"
          ...
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.heightPx')}</span>
            <Input
              type="number"
              inputMode="decimal"
              step="1"
          ...
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground">{t('converter.outputCm')}</span>
            <Input type="text" readOnly value={cmFromPx} />
          </div>
        </div>

        <p className="text-xs text-muted-foreground">{t('converter.formulaNote')}</p>
      </div>
    </div>
  );
}
