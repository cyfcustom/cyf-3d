...
type Props = {
  totals: ReturnType<typeof useLabelsCalculator>['totals'];
  onReset: () => void;
};

export function LabelsSummaryCard({ totals, onReset }: Props) {
  ...
  return (
    <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
      <div className="flex items-center justify-between gap-3">
        <h3 className="text-lg font-semibold">{t('summaryModule.labels')}</h3>
