...
export function LabelsLaborCard({
  state,
  onChange,
}: {
  state: ReturnType<typeof useLabelsCalculator>['state']['labor'];
    ...
    <div className="card bg-card border border-border rounded-2xl shadow-sm p-6 space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{t('descriptions.laborLabels')}</p>
        </div>
